...
public class BookingClient extends BaseClient {
    ...
    public ResponseEntity<Object> getBookings(long userId, BookingState status, Integer from, Integer size) {
    ...
    public ResponseEntity<Object> getOwnerBookings(long userId, BookingState status, Integer from, Integer size) {
        Map<String, Object> params = Map.of(
                "state", status,
                "from", from,
                "size", size
