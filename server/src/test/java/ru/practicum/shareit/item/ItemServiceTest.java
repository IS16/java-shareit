...
public class ItemServiceTest {
    ...
    void shouldCreateItem() {
        UserDto user = new UserDto(1L, "admin", "admin@shareit.ru");
    ...
    void shouldThrowExceptionWhenDeleteItemByUserNotOwner() {
        UserDto user = new UserDto(3L, "admin", "admin@shareit.ru");
        UserDto user1 = new UserDto(4L, "test", "test@shareit.ru");
    ...
    void shouldCreateComment() {
        ...
        UserDto user1 = new UserDto(5L, "test", "test@shareit.ru");
        UserDto newUserDto1 = userService.createUser(user1);
    ...
    void shouldThrowExceptionWhenUpdateWithUserNotOwner() {
        ...
        UserDto newUserDto1 = userService.createUser(new UserDto(4L, "support", "support@shareit.ru"));
